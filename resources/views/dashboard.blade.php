...
<div class="owl-carousel counter-carousel owl-theme">
      ...
      <div class="card border-0 zoom-in bg-light-primary shadow-none">
        <div class="card-body">
          <div class="text-center">
            <img src="{{asset('backend')}}/dist/images/svgs/icon-user-male.svg" width="50" height="50" class="mb-3" alt="" />
    ...
    <div class="item">
      <div class="card border-0 zoom-in bg-light-warning shadow-none">
        <div class="card-body">
          <div class="text-center">
            <img src="{{asset('backend')}}/dist/images/svgs/icon-briefcase.svg" width="50" height="50" class="mb-3" alt="" />
    ...
    <div class="item">
      <div class="card border-0 zoom-in bg-light-info shadow-none">
        <div class="card-body">
          <div class="text-center">
            <img src="{{asset('backend')}}/dist/images/svgs/icon-mailbox.svg" width="50" height="50" class="mb-3" alt="" />
    ...
    <div class="item">
      <div class="card border-0 zoom-in bg-light-danger shadow-none">
        <div class="card-body">
          <div class="text-center">
            <img src="{{asset('backend')}}/dist/images/svgs/icon-favorites.svg" width="50" height="50" class="mb-3" alt="" />
    ...
    <div class="item">
      <div class="card border-0 zoom-in bg-light-success shadow-none">
        <div class="card-body">
          <div class="text-center">
            <img src="{{asset('backend')}}/dist/images/svgs/icon-speech-bubble.svg" width="50" height="50" class="mb-3" alt="" />
    ...
    <div class="item">
      <div class="card border-0 zoom-in bg-light-info shadow-none">
        <div class="card-body">
          <div class="text-center">
            <img src="{{asset('backend')}}/dist/images/svgs/icon-connect.svg" width="50" height="50" class="mb-3" alt="" />
      ...
      <div class="card">
        <div class="card-body">
          <div class="d-flex align-items-center mb-7 pb-2">
            <div class="me-3 pe-1">
              <img src="{{asset('backend')}}/dist/images/profile/user-1.jpg" class="shadow-warning rounded-2" alt="" width="72" height="72" />
            </div>
            <div>
            ...
            <ul class="hstack mb-0">
              <li class="ms-n8">
                <a href="javascript:void(0)" class="me-1">
                  <img src="{{asset('backend')}}/dist/images/profile/user-2.jpg" class="rounded-circle border border-2 border-white" width="44" height="44" alt="" />
                </a>
              </li>
              <li class="ms-n8">
                <a href="javascript:void(0)" class="me-1">
                  <img src="{{asset('backend')}}/dist/images/profile/user-3.jpg" class="rounded-circle border border-2 border-white" width="44" height="44" alt="" />
                </a>
              </li>
              <li class="ms-n8">
                <a href="javascript:void(0)" class="me-1">
                  <img src="{{asset('backend')}}/dist/images/profile/user-4.jpg" class="rounded-circle border border-2 border-white" width="44" height="44" alt="" />
                </a>
              </li>
              <li class="ms-n8">
                <a href="javascript:void(0)" class="me-1">
                  <img src="{{asset('backend')}}/dist/images/profile/user-5.jpg" class="rounded-circle border border-2 border-white" width="44" height="44" alt="" />
                </a>
              </li>
            </ul>
      ...
      <div class="card bg-primary border-0 w-100">
        <div class="card-body pb-0">
          ...
          <div class="text-center mt-3">
            <img src="{{asset('backend')}}/dist/images/backgrounds/piggy.png" class="img-fluid" alt="" />
          </div>
        </div>
              ...
              <tbody class="border-top">
                ...
                <tr>
                  <td class="ps-0">
                    <div class="d-flex align-items-center">
                      <div class="me-2 pe-1">
                        <img src="{{asset('backend')}}/dist/images/profile/user-2.jpg" class="rounded-circle" width="40" height="40" alt="" />
                      </div>
                      <div>
                ...
                <tr>
                  <td class="ps-0">
                    <div class="d-flex align-items-center">
                      <div class="me-2 pe-1">
                        <img src="{{asset('backend')}}/dist/images/profile/user-3.jpg" class="rounded-circle" width="40" height="40" alt="" />
                      </div>
                      <div>
                ...
                <tr>
                  <td class="ps-0">
                    <div class="d-flex align-items-center">
                      <div class="me-2 pe-1">
                        <img src="{{asset('backend')}}/dist/images/profile/user-4.jpg" class="rounded-circle" width="40" height="40" alt="" />
                      </div>
                      <div>
                ...
                <tr>
                  <td class="border-0 ps-0">
                    <div class="d-flex align-items-center">
                      <div class="me-2 pe-1">
                        <img src="{{asset('backend')}}/dist/images/profile/user-5.jpg" class="rounded-circle" width="40" height="40" alt="" />
                      </div>
                      <div>
