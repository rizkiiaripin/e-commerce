        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center lg:space-x-2">
                ...
                <div id="myCartDropdown1"
                    class="hidden fixed top-20 right-3 z-10  max-w-sm space-y-4 overflow-hidden rounded-lg bg-white p-4 antialiased shadow-lg dark:bg-gray-800">
...
@push('script')
    <script>
        $(document).ready(function() {
            ...
            $('#myCartDropdownButton1').click(function(e) {
                e.stopPropagation(); // Hentikan event bubbling ke window
                $('#myCartDropdown1').fadeToggle();
            });

            // Hentikan klik di dalam dropdown menutup dropdown
            $('#myCartDropdown1').click(function(e) {
                e.stopPropagation();
            });

            // Klik di luar akan menutup dropdown
            $(window).click(function() {
                $('#myCartDropdown1').fadeOut();
            });
